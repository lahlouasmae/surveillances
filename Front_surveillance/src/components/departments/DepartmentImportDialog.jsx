...
const DepartmentImportDialog = ({ open, onClose, onImportSuccess }) => {
  ...
  const handleImport = async () => {
    ...
    try {
      await axios.post('http://localhost:8080/api/departments/import', formData, {
        headers: {
  ...
  return (
    <Dialog open={open} onClose={handleClose} maxWidth="sm" fullWidth>
      <DialogTitle>Importer des Départements</DialogTitle>
      <DialogContent>
        <Box sx={{ p: 2 }}>
          <Typography variant="body1" sx={{ mb: 2 }}>
            Sélectionnez un fichier CSV contenant les données des départements.
          </Typography>
