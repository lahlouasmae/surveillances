...
const LocalImportDialog = ({ open, onClose, onImportSuccess }) => {
  ...
  const handleImport = async () => {
    ...
    try {
      await axios.post('http://localhost:8080/api/locals/import', formData, {
        headers: {
      ...
      console.error('Error importing locals:', error);
    } finally {
      ...
      <DialogContent>
        <Box sx={{ p: 2 }}>
          <Typography variant="body1" sx={{ mb: 2 }}>
            Sélectionnez un fichier CSV contenant les données des locaux.
          </Typography>
