...
const OptionImportDialog = ({ open, onClose, onImportSuccess }) => {
  ...
  const handleImport = async () => {
    ...
    try {
      await axios.post('http://localhost:8080/api/options/import', formData, {
        headers: {
      ...
      <DialogContent>
        <Box sx={{ p: 2 }}>
          <Typography variant="body1" sx={{ mb: 2 }}>
            Sélectionnez un fichier CSV contenant les données des options.
          </Typography>
...
export default OptionImportDialog;